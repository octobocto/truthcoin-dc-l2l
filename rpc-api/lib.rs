...
pub mod node {
    ...
    use plain_bitassets::{
        ...
        types::{
            ...
            BlockIndexTx, Body, Coinbase, CoinbaseTxid, DutchAuctionId,
            DutchAuctionParams, EncryptionPubKey, FilledOutput,
            FilledOutputContent, Header, InPoint, Inputs, M6id,
            MainchainSyncPhase, MainchainSyncProgress, MempoolTx, MerkleRoot,
            OutPoint, Output, OutputContent, Outputs, PointedOutput,
            SpentOutput, Transaction, TxData, TxIn, Txid, VerifyingKey,
    ...
    #[open_api(ref_schemas[
        ...
        Body, Coinbase, CoinbaseTxid, DutchAuctionId, DutchAuctionParams, EncryptionPubKey,
...
pub mod wallet {
    ...
    use plain_bitassets::{
        ...
        types::{
            ...
            Coinbase, CoinbaseTxid, DutchAuctionId, DutchAuctionParams,
            EncryptionPubKey, FilledOutput, FilledOutputContent, Header,
            InPoint, Inputs, M6id, MainchainSyncPhase, MerkleRoot, OutPoint,
            Output, OutputContent, Outputs, PointedOutput, SpentOutput,
            Transaction, TxData, TxIn, Txid, VerifyingKey,
